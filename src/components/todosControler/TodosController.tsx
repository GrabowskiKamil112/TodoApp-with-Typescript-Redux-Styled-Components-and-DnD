...
const TodosController: React.FC<ITodosController> = ({
    themeContext,
    removeCompletedFn,
    showTodos,
    showType,
    ...
    return (
        <>
            <Tooltip component={isMobile ? buttonRef : buttonRef1} content={'completed will be removen'} />
            ...
            <StyledController themeCtx={themeContext}>
                ...
                <StyledWrapper>
                    <Button
                        ...
                        isActive={showType === ALL ? true : false}>
                        All
                    </Button>
                    <Button
                        themeCtx={themeContext}
                        ...
                        isActive={showType === ACTIVE ? true : false}>
                        Active
                    </Button>
                    <Button
                        themeCtx={themeContext}
                        ...
                        isActive={showType === COMPLETED ? true : false}>
                        Completed
                    </Button>
                </StyledWrapper>
                {!isMobile && (
